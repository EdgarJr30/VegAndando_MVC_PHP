<main>
    ...
    <section class="travel_adds_contain top60px">
        ...
        <div class="tips">
            ...
            <picture>
                <source srcset="../img/viajes/incluye/<?php echo $viaje->imgincluye; ?>.webp" type="image/webp">
                <source srcset="../img/viajes/incluye/<?php echo $viaje->imgincluye; ?>.png" type="image/png">
                <img loading="lazy" src="../img/viajes/incluye/<?php echo $viaje->imgincluye; ?>.png" alt="Imagen Viaje">
            </picture>
            <!-- <img src="./img/el-viaje-incluye.png" alt="" /> -->
        </div>
    </section>
    ...
    <section class="prohibido__container top60px">
        ...
        <div class="prohibiciones top15px">
            ...
            <img src="../img/svg+/prohibidos/vestido.svg" alt="vestido" />
        ...
        <div class="date_info width-aviable">
            ...
            <!-- <div class="coming_soon">
                <div class="title_countdown">
                    ...
                    <p class="recuerda_countdown top45px">
                        Recuerda que para agendar tu cupo debes hacerlo con más de una
