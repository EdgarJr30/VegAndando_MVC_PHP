...
<head>
    ...
    <title>VegAndando - <?php echo $titulo; ?></title>
    ...
    <meta name="image" property="og:image" content="/img/ogimg.jpg" />
    <link rel="icon" type="image/x-icon" href="/img/png/Icono Logo VegAndando.png" />
